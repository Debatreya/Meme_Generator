...
// TODO
// show a random meme in the current location
...
// TODO
// show a random joke in the current location
...
function showJoke() {
    ...
    let joketext = document.createTextNode(randomJokeText)
    jokeelement.appendChild(joketext);
    jokeContainer.appendChild(jokeelement)
}
// TODO
// show a random quote in the current location
...
// TODO
// show a random riddle in the current location
...
function getRandomData(type){
    ...
    return data[type][rn(data[type].length)];//note this
}
//Clearall
function clearAll() {
